        ...
        <div className="item pb-60">
          <div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <div className="title mt-30">
                  <h5 className="fw-600">Auditoría SEO Completa</h5>
                </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <div className="title mt-30">
                  <h5 className="fw-600">Publicidad en Google Ads y Meta Ads</h5>
                </div>
                <div className="text mt-20">
                  <p>
          ...
          <div className="row justify-content-center">
              <div className="col-lg-10">
                <div className="title mt-30">
                  <h5 className="fw-600">Análisis y Reportes Detallados</h5>
                </div>
                <div className="text mt-20">
