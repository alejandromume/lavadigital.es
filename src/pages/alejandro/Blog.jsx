        ...
        <div className="sec-head mb-80">
          <div className="row">
            <div className="col-lg-6">
              ...
              <h2 className="fz-50">Lee nuestras <span className='gradient'>últimas</span> noticias.</h2>
            </div>
                  ...
                  <SwiperSlide key={item.id} className="wow fadeInUp" data-wow-delay=".1s">
                    <div className="item">
                      ...
                      <div className="cont mt-30">
                        ...
                        <Link href="#" className="mt-20 ls1 sub-title">
                          Próximamente disponible <i className="ml-5">
