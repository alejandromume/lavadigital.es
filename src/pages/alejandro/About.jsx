        ...
        <div className="row md-marg justify-content-center">
          <div className="col-lg-6">
            <div className="cont md-mb50">
              <div className="mb-50">
                <h6 className="sub-title mb-15">Qué hacemos en lava creativa ?</h6>
                <h3 className='fz-48'>Marketing digital que <span className='gradient'>conecta, crea y convierte</span></h3>
              </div>
              ...
              <div className="item d-flex align-items-center pb-20 mb-20 bord-thin-bottom">
                ...
                <div>
                  <h6>Posicionamiento en internet (SEO/SEM)</h6>
              ...
              <div className="item d-flex align-items-center pb-20 bord-thin-bottom">
                ...
                <div>
                  ...
                  <p>Conoce todo sobre tu público en <br /> redes sociales y llevalas al siguiente nivel.</p>
                  <Link href="/media-planning" className="arrow mt-20">
                    <span className="fz-13 mr-10">Quiero saber más</span>
                    <span className="circle">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-lg-5 offset-lg-1">
            <div ref={parallax.ref}>
              <img src={`/${lightMode ? 'light' : 'dark'}/assets/imgs/img2.avif`} alt="" />
            </div>
          </div>
        </div>
      </div>
